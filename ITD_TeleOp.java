...
public class ITD_TeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addData("Intialize",1); // Test code, to make sure telemetry works
        ...
        waitForStart();
        telemetry.addData("Start",1); // Test code again
        
        if (isStopRequested()) return;
        
        while (opModeIsActive()) {
            double drive /*Front and Back*/ = -gamepad1.left_stick_y; // Y stick value is reversed
            double strafe /*Left to Right*/ = gamepad1.left_stick_x * 1.1; // Counteract imperfect strafing
            double twist /*Turning*/ = gamepad1.right_stick_x; // This is the RIGHT stick, in a way indpendent of drive and strafe
