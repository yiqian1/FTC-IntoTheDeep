...
@Autonomous
//@Disabled
public class NetZoneSpeciAuto extends LinearOpMode {
    ...
    public final double     DRIVE_SPEED             = 0.45;     // Max driving speed for better distance accuracy.
